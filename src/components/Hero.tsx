import { ArrowRight, Code2, Database, Github, Shield, Zap } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-b from-background via-background/80 to-transparent blur-2xl -z-10 scale-125" />
          ...
          {/* Subheading */}
          <div className="relative">
            <div className="absolute inset-0 bg-background/70 blur-2xl -z-10 scale-125" />
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Index 3rd party documentation from websites, GitHub, npm, PyPI,
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Button
              variant="code"
              className="font-mono text-left px-6 py-3 w-full"
              asChild
            >
              <code>npm install -g @arabold/docs-mcp-server</code>
            </Button>
          </div>
        </div>
      </div>
